  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="text-sm">
        Unsanctioned: <b>{totalUnsanctioned}</b> | High: <b>{highRisk}</b> | Users:{' '}
        <b>{usersInvolved}</b> | Remediated: <b>{remediated}</b>
      </div>

      <button
        className="px-3 py-2 rounded bg-red-600 text-white"
        onClick={() => revokeApp('app_sketchymail')}
      >
      ...
      <p className="text-xs text-neutral-500">
        After clicking <b>Revoke</b>, the KPIs above should update immediately, and the app’s status
        will become <b>Revoked</b>.
      </p>
    </div>
  );
}
