  ...
  return (
    <div className="container mx-auto p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">QA Dashboard</h1>
          <p className="text-muted-foreground">Review and test shadow IT detections</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-red-500">1.5%</div>
          </CardContent>
        </Card>
      </div>
